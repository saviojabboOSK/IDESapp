...
#
# This module contains advanced LLM prompt templates for specialized use cases.
# While the main application uses the MAIN_TEMPLATE in llm_service.py, this file
# provides additional structured prompts for:
...
#
# NOTE: These prompts are NOT currently used in the main application workflow.
# They are provided for future enhancements or alternative processing approaches.

import json

# ─── Query Analysis Prompt ─────────────────────────────────────────────────
# This prompt is designed for a two-stage processing approach:
# 1. First, analyze user intent and extract parameters
# 2. Then, generate appropriate response based on analysis
# Currently unused - the main app uses single-stage processing in llm_service.py
